...
public class Aufgabe1Test {
	public static void main(String[] args) {
		...
		System.out.println(Vektor2D.berechneWinkel(w1,w2)); 			//Winkel im Gradma� wird berechnet =  90�
		System.out.println(w1.berechneWinkel(w2)); 						//Winkel im Gradma� wird berechnet, dies sind 90�
		...
		System.out.println(w1.berechneWinkelBogenMa�(w2));				//Winkel wird im Bogenma� berechnet, entspricht 90�
		System.out.println(Vektor2D.berechneWinkelBogenMa�(w1, w2)); 	//Winkel wird im Bogenma� berechnet, entspricht 90�
		System.out.println("\n//Punkt3D Test:");
		...
		System.out.println(Vektor3D.berechneWinkel(w23, w13));			//Winkel im Gradma� wird berechnet =  90�
		System.out.println(w13.berechneWinkel(w23)); 					//Winkel im Gradma� wird berechnet =  90�
		...
		System.out.println(w13.berechneWinkelBogenMa�(w23));			//Winkel wird im Bogenma� berechnet, entspricht 90�
		System.out.println(Vektor3D.berechneWinkelBogenMa�(w23, w13)); 	//Winkel wird im Bogenma� berechnet, entspricht 90�
